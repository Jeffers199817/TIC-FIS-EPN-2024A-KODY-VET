...
class Email {
    ...
    public function enviarConfirmacion() {
         ...
         $mail->setFrom('cuentas@milenyum_dog.com');
         ...
         $contenido = '<html>';
         $contenido .= "<p><strong>Hola " . $this->nombre .  "</strong> Has Registrado Correctamente tu cuenta en Milenyum_dog pero es necesario confirmarla</p>";
