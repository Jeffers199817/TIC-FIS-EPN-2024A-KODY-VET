<aside class="dashboard__sidebar">
    <nav class="dashboard__menu">
        ...
        <span class="dashboard__menu-texto">
           ...
           <a href="/admin/prompts" class="dashboard__enlace <?php echo pagina_actual('/prompts')?'dashboard__enlace--actual': ''?> ">
          <i class="fa-solid fa-question"  class="dashboard__icono"></i>
        <span class="dashboard__menu-texto">
            Prompts
        </span>
        </a>
